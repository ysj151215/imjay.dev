    ...
    if (href) {
      return (
        <>
          ...
          {gitSrc && (
            <a className="btn min-w-0 mt-6 ml-4 px-4" href={gitSrc} rel="noopener noreferrer" target="_blank">
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="flex flex-col justify-between mt-5 md:flex-row">
        <h3 className="w-full mb-2 text-lg md:text-xl font-medium text-gray-900 dark:text-gray-100">{title}</h3>
      </div>
