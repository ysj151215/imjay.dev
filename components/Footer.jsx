...
export default function Footer() {
  return (
    <footer className="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8">
      <hr className="w-full border border-gray-800 mb-8" />
      <div className="w-full max-w-2xl grid grid-cols-1 sm:grid-cols-3 gap-4 pb-16">
        <div className="flex flex-col space-y-4">
          <Link href="/">
            <a className="text-gray-400 hover:text-gray-200 transition">概览</a>
          </Link>
          <Link href="/projects">
          ...
          <Link href="/blog">
            <a className="text-gray-400 hover:text-gray-200 transition">博客</a>
          </Link>
        </div>
        <div className="flex flex-col space-y-4">
          <Link href="/uses">
          ...
          <Link href="/wallpapers">
            <a className="text-gray-400 hover:text-gray-200 transition">壁纸</a>
          </Link>
        </div>
        <div className="flex flex-col space-y-4">
